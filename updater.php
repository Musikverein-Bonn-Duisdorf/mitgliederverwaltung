...
adminListPageBegin('System', 'Updater');
?>
...
<div class="w3-card-4 w3-margin">
  ...
  <div class="w3-padding">
    <p>„Auf Updates prüfen“ holt den Remote-Stand und zeigt, ob Commits verfügbar sind.
      ...
      Datenbank prüfen/reparieren kann unabhängig davon ausgeführt werden.
      Betrifft nur Tabellen mit Prefix <code><?php echo htmlspecialchars((string)$GLOBALS['dbprefix'], ENT_QUOTES, 'UTF-8'); ?></code>.</p>
  </div>
