...
$cmd = (string)mitRequest('cmd', '');
switch($cmd) {
case 'change':
    if(!mitRequest('para') || mitRequest('value') === null) {
        die('missing para/value');
    }
    $para = (string)mitRequest('para');
    $value = (string)mitRequest('value');
...
case 'schemeName':
    ...
    $newName = trim((string)mitRequest('value'));
